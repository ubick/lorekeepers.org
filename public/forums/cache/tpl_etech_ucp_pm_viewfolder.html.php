...
<?php } else { if ($this->_rootref['S_PM_ICONS']) {  $_messagerow_count = (isset($this->_tpldata['messagerow'])) ? sizeof($this->_tpldata['messagerow']) : 0;if ($_messagerow_count) {for ($_messagerow_i = 0; $_messagerow_i < $_messagerow_count; ++$_messagerow_i){$_messagerow_val = &$this->_tpldata['messagerow'][$_messagerow_i]; if ($_messagerow_val['PM_ICON_IMG']) {  $this->_tpldata['DEFINE']['.']['CA_HAS_ICONS'] = 1; } }} if (! $this->_tpldata['DEFINE']['.']['CA_HAS_ICONS']) {  $this->_tpldata['DEFINE']['.']['CA_EXTRA_COL'] = ' colspan="2"'; } } ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; if ($this->_rootref['CUR_FOLDER_NAME']) {  echo (isset($this->_rootref['CUR_FOLDER_NAME'])) ? $this->_rootref['CUR_FOLDER_NAME'] : ''; } else { echo ((isset($this->_rootref['L_PRIVATE_MESSAGES'])) ? $this->_rootref['L_PRIVATE_MESSAGES'] : ((isset($user->lang['PRIVATE_MESSAGES'])) ? $user->lang['PRIVATE_MESSAGES'] : '{ PRIVATE_MESSAGES }')); } echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
