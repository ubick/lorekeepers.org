...
<tr>
	<td colspan="2" class="row2">
		...
		<tr>
			<td colspan="2"><textarea class="posting-textarea" name="signature" rows="10" cols="76" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();"><?php echo (isset($this->_rootref['SIGNATURE'])) ? $this->_rootref['SIGNATURE'] : ''; ?></textarea></td>
		</tr>
