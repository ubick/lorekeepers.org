...
<!--[if lte IE 6]><script type="text/javascript" src="<?php echo (isset($this->_rootref['T_TEMPLATE_PATH'])) ? $this->_rootref['T_TEMPLATE_PATH'] : ''; ?>/ca_ie6.js"></script><![endif]-->
...
<div id="global" style="margin: 0 auto;">
    ...
    <div id="topnav-right">
        <ul class="linklist topnav leftside">
            <?php if ($this->_rootref['S_USER_LOGGED_IN']) {  if ($this->_rootref['S_DISPLAY_MEMBERLIST']) {  ?>
	...
	<div id="logo"><span class="logo-left"></span><span class="logo-right"></span><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php echo (isset($this->_rootref['SITE_LOGO_IMG'])) ? $this->_rootref['SITE_LOGO_IMG'] : ''; ?><span><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?></span></a></div>
