...
<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; if ($this->_rootref['S_REPORT_POST']) {  echo ((isset($this->_rootref['L_REPORT_POST'])) ? $this->_rootref['L_REPORT_POST'] : ((isset($user->lang['REPORT_POST'])) ? $user->lang['REPORT_POST'] : '{ REPORT_POST }')); } else { echo ((isset($this->_rootref['L_REPORT_MESSAGE'])) ? $this->_rootref['L_REPORT_MESSAGE'] : ((isset($user->lang['REPORT_MESSAGE'])) ? $user->lang['REPORT_MESSAGE'] : '{ REPORT_MESSAGE }')); } echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
