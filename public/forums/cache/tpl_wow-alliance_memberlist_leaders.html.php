...
<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_THE_TEAM'])) ? $this->_rootref['L_THE_TEAM'] : ((isset($user->lang['THE_TEAM'])) ? $user->lang['THE_TEAM'] : '{ THE_TEAM }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
...
<tr>
	<td class="row3" colspan="5"><b class="gensmall"><?php echo ((isset($this->_rootref['L_ADMINISTRATORS'])) ? $this->_rootref['L_ADMINISTRATORS'] : ((isset($user->lang['ADMINISTRATORS'])) ? $user->lang['ADMINISTRATORS'] : '{ ADMINISTRATORS }')); ?></b></td>
</tr>
<?php $_admin_count = (isset($this->_tpldata['admin'])) ? sizeof($this->_tpldata['admin']) : 0;if ($_admin_count) {for ($_admin_i = 0; $_admin_i < $_admin_count; ++$_admin_i){$_admin_val = &$this->_tpldata['admin'][$_admin_i]; if (!($_admin_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row2"><?php } else { ?><tr class="row1"><?php } ?>
	...
	<td class="row gen" align="center"><strong><?php echo $_admin_val['USERNAME_FULL']; ?></strong></td>
	<td class="row gensmall" align="center">&nbsp;</td>
	<td class="row gensmall" align="center" nowrap="nowrap">&nbsp;
	...
	&nbsp;</td>
	<td class="row gen" align="center"><?php if ($_admin_val['RANK_IMG']) {  echo $_admin_val['RANK_IMG']; } else { echo $_admin_val['RANK_TITLE']; } ?></td>
	<td class="row gen" align="center">&nbsp;<?php if ($_admin_val['U_PM']) {  ?><a href="<?php echo $_admin_val['U_PM']; ?>"><?php echo (isset($this->_rootref['PM_IMG'])) ? $this->_rootref['PM_IMG'] : ''; ?></a><?php } ?>&nbsp;</td>
</tr>
<?php }} else { ?>
...
<tr>
	<td class="row3" colspan="5"><b class="gensmall"><?php echo ((isset($this->_rootref['L_MODERATORS'])) ? $this->_rootref['L_MODERATORS'] : ((isset($user->lang['MODERATORS'])) ? $user->lang['MODERATORS'] : '{ MODERATORS }')); ?></b></td>
</tr>
<?php $_mod_count = (isset($this->_tpldata['mod'])) ? sizeof($this->_tpldata['mod']) : 0;if ($_mod_count) {for ($_mod_i = 0; $_mod_i < $_mod_count; ++$_mod_i){$_mod_val = &$this->_tpldata['mod'][$_mod_i]; if (!($_mod_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row2"><?php } else { ?><tr class="row1"><?php } ?>
	...
	<td class="row gen" align="center"><strong><?php echo $_mod_val['USERNAME_FULL']; ?></strong></td>
	<td class="row" align="center"><?php if (! $_mod_val['FORUMS']) {  echo ((isset($this->_rootref['L_ALL_FORUMS'])) ? $this->_rootref['L_ALL_FORUMS'] : ((isset($user->lang['ALL_FORUMS'])) ? $user->lang['ALL_FORUMS'] : '{ ALL_FORUMS }')); } else { ?><select style="width: 200px;"><?php echo $_mod_val['FORUMS']; ?></select><?php } ?>&nbsp;</td>
	<td class="row gensmall" align="center" nowrap="nowrap">&nbsp;
	...
	&nbsp;</td>
	<td class="row gen" align="center"><?php if ($_mod_val['RANK_IMG']) {  echo $_mod_val['RANK_IMG']; } else { echo $_mod_val['RANK_TITLE']; } ?></td>
	<td class="row gen" align="center">&nbsp;<?php if ($_mod_val['U_PM']) {  ?><a href="<?php echo $_mod_val['U_PM']; ?>"><?php echo (isset($this->_rootref['PM_IMG'])) ? $this->_rootref['PM_IMG'] : ''; ?></a><?php } ?>&nbsp;</td>
</tr>
<?php }} else { ?>
