...
<div id="pagecontent">
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_VIEWING_PROFILE'])) ? $this->_rootref['L_VIEWING_PROFILE'] : ((isset($user->lang['VIEWING_PROFILE'])) ? $user->lang['VIEWING_PROFILE'] : '{ VIEWING_PROFILE }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
	...
	<tr>
		<td class="row1" align="center">
			...
			<tr>
				<td align="center"><?php if ($this->_rootref['USER_COLOR']) {  ?><b class="gen" style="color: <?php echo (isset($this->_rootref['USER_COLOR'])) ? $this->_rootref['USER_COLOR'] : ''; ?>"><?php } else { ?><b class="gen"><?php } echo (isset($this->_rootref['USERNAME'])) ? $this->_rootref['USERNAME'] : ''; ?></b></td>
			</tr>
			...
			<?php } if ($this->_rootref['U_USER_BAN']) {  ?>

			<tr>
			    <td class="genmed" align="center">[ <a href="<?php echo (isset($this->_rootref['U_USER_BAN'])) ? $this->_rootref['U_USER_BAN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_USER_BAN'])) ? $this->_rootref['L_USER_BAN'] : ((isset($user->lang['USER_BAN'])) ? $user->lang['USER_BAN'] : '{ USER_BAN }')); ?></a> ]</td>
			</tr>
			<?php } if ($this->_rootref['U_USER_ADMIN']) {  ?>

			<tr>
			    <td class="genmed" align="center">[ <a href="<?php echo (isset($this->_rootref['U_USER_ADMIN'])) ? $this->_rootref['U_USER_ADMIN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_USER_ADMIN'])) ? $this->_rootref['L_USER_ADMIN'] : ((isset($user->lang['USER_ADMIN'])) ? $user->lang['USER_ADMIN'] : '{ USER_ADMIN }')); ?></a> ]</td>
			</tr>
