<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('ucp_header.html'); if ($this->_rootref['S_EDIT']) {  if ($this->_rootref['S_ERROR']) {  ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_USERGROUPS'])) ? $this->_rootref['L_USERGROUPS'] : ((isset($user->lang['USERGROUPS'])) ? $user->lang['USERGROUPS'] : '{ USERGROUPS }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
	...
	<?php if (! $this->_rootref['S_IN_AVATAR_GALLERY']) {  if ($this->_rootref['S_UPLOAD_AVATAR_FILE']) {  ?>
		...
		<?php } if ($this->_rootref['S_DISPLAY_GALLERY']) {  ?>
			...
			<tr>
				...
				<td class="row2"><input class="btnlite" type="submit" name="display_gallery" value="<?php echo ((isset($this->_rootref['L_DISPLAY_GALLERY'])) ? $this->_rootref['L_DISPLAY_GALLERY'] : ((isset($user->lang['DISPLAY_GALLERY'])) ? $user->lang['DISPLAY_GALLERY'] : '{ DISPLAY_GALLERY }')); ?>" /></td>
			</tr>
		<?php } } else { ?>
		...
		<tr>
			...
			<td class="row2"><select name="category" id="category"><?php echo (isset($this->_rootref['S_CAT_OPTIONS'])) ? $this->_rootref['S_CAT_OPTIONS'] : ''; ?></select>&nbsp;<input class="btnlite" type="submit" value="<?php echo ((isset($this->_rootref['L_GO'])) ? $this->_rootref['L_GO'] : ((isset($user->lang['GO'])) ? $user->lang['GO'] : '{ GO }')); ?>" name="display_gallery" /></td>
		</tr>
		<tr>
			...
			<td class="row2"><input class="btnlite" type="submit" name="cancel" value="<?php echo ((isset($this->_rootref['L_CANCEL'])) ? $this->_rootref['L_CANCEL'] : ((isset($user->lang['CANCEL'])) ? $user->lang['CANCEL'] : '{ CANCEL }')); ?>" /></td>
		</tr>
	...
	<tr>
		<td class="cat" colspan="2" align="center"><input class="btnmain" type="submit" id="submit" name="update" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" />&nbsp;
		<input class="btnlite" type="reset" id="reset" name="reset" value="<?php echo ((isset($this->_rootref['L_RESET'])) ? $this->_rootref['L_RESET'] : ((isset($user->lang['RESET'])) ? $user->lang['RESET'] : '{ RESET }')); ?>" /></td>
	</tr>
	</table>
...
<?php } else if ($this->_rootref['S_LIST']) {  ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_GROUP_INFORMATION'])) ? $this->_rootref['L_GROUP_INFORMATION'] : ((isset($user->lang['GROUP_INFORMATION'])) ? $user->lang['GROUP_INFORMATION'] : '{ GROUP_INFORMATION }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
	...
	<?php $_leader_count = (isset($this->_tpldata['leader'])) ? sizeof($this->_tpldata['leader']) : 0;if ($_leader_count) {for ($_leader_i = 0; $_leader_i < $_leader_count; ++$_leader_i){$_leader_val = &$this->_tpldata['leader'][$_leader_i]; if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
			...
			<td class="row"><?php echo $_leader_val['USERNAME_FULL']; ?></td>
			<td class="row" style="text-align: center;"><?php if ($_leader_val['S_GROUP_DEFAULT']) {  echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); } else { echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); } ?></td>
			<td class="row" style="text-align: center;"><?php echo $_leader_val['JOINED']; ?></td>
			<td class="row" style="text-align: center;"><?php echo $_leader_val['USER_POSTS']; ?></td>
	...
	<?php }} $_member_count = (isset($this->_tpldata['member'])) ? sizeof($this->_tpldata['member']) : 0;if ($_member_count) {for ($_member_i = 0; $_member_i < $_member_count; ++$_member_i){$_member_val = &$this->_tpldata['member'][$_member_i]; if ($_member_val['S_PENDING']) {  ?>
		...
		<?php } else { if (!($_member_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
				...
				<td class="row"><?php echo $_member_val['USERNAME_FULL']; ?></td>
				<td class="row" style="text-align: center;"><?php if ($_member_val['S_GROUP_DEFAULT']) {  echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); } else { echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); } ?></td>
				<td class="row" style="text-align: center;"><?php echo $_member_val['JOINED']; ?></td>
				<td class="row" style="text-align: center;"><?php echo $_member_val['USER_POSTS']; ?></td>
				<td class="row" style="text-align: center;"><input type="checkbox" class="radio" name="mark[]" value="<?php echo $_member_val['USER_ID']; ?>" /></td>
			</tr>
		<?php } }} else { ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_ADD_USERS'])) ? $this->_rootref['L_ADD_USERS'] : ((isset($user->lang['ADD_USERS'])) ? $user->lang['ADD_USERS'] : '{ ADD_USERS }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
	...
	<tr>
		<td class="cat" colspan="2" align="center"><input class="btnlite" type="submit" name="addusers" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" /></td>
	</tr>
	</table>
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_BLOCK_END'])) ? $this->_tpldata['DEFINE']['.']['CA_BLOCK_END'] : ''; ?>
...
<?php } else { ?>
	...
	<?php $_leader_count = (isset($this->_tpldata['leader'])) ? sizeof($this->_tpldata['leader']) : 0;if ($_leader_count) {for ($_leader_i = 0; $_leader_i < $_leader_count; ++$_leader_i){$_leader_val = &$this->_tpldata['leader'][$_leader_i]; if (($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
		...
		<td class="row"><b class="genmed"<?php if ($_leader_val['GROUP_COLOUR']) {  ?> style="color: #<?php echo $_leader_val['GROUP_COLOUR']; ?>;"<?php } ?>><?php echo $_leader_val['GROUP_NAME']; ?></b><?php if ($_leader_val['GROUP_DESC']) {  ?><p class="forumdesc"><?php echo $_leader_val['GROUP_DESC']; ?></p><?php } ?></td>
		<td class="row" style="text-align: center;"><a href="<?php echo $_leader_val['U_EDIT']; ?>"><?php echo ((isset($this->_rootref['L_EDIT'])) ? $this->_rootref['L_EDIT'] : ((isset($user->lang['EDIT'])) ? $user->lang['EDIT'] : '{ EDIT }')); ?></a></td>
		<td class="row" style="text-align: center;"><a href="<?php echo $_leader_val['U_LIST']; ?>"><?php echo ((isset($this->_rootref['L_GROUP_LIST'])) ? $this->_rootref['L_GROUP_LIST'] : ((isset($user->lang['GROUP_LIST'])) ? $user->lang['GROUP_LIST'] : '{ GROUP_LIST }')); ?></a></td>
