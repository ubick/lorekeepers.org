...
document.write('#logo-left { background-image: url(<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/logo_left' + rand_left + '.gif); } ');
document.write('#logo-right { background-image: url(<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/logo_right' + rand_right + '.gif); } ');
