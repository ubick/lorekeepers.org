<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('mcp_header.html'); if ($this->_rootref['S_MCP_REPORT']) {  ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; if ($this->_rootref['S_PM']) {  echo ((isset($this->_rootref['L_PM_REPORT_DETAILS'])) ? $this->_rootref['L_PM_REPORT_DETAILS'] : ((isset($user->lang['PM_REPORT_DETAILS'])) ? $user->lang['PM_REPORT_DETAILS'] : '{ PM_REPORT_DETAILS }')); } else { echo ((isset($this->_rootref['L_REPORT_DETAILS'])) ? $this->_rootref['L_REPORT_DETAILS'] : ((isset($user->lang['REPORT_DETAILS'])) ? $user->lang['REPORT_DETAILS'] : '{ REPORT_DETAILS }')); } echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
...
<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; if ($this->_rootref['S_PM']) {  echo ((isset($this->_rootref['L_PM'])) ? $this->_rootref['L_PM'] : ((isset($user->lang['PM'])) ? $user->lang['PM'] : '{ PM }')); } else { echo ((isset($this->_rootref['L_POST_DETAILS'])) ? $this->_rootref['L_POST_DETAILS'] : ((isset($user->lang['POST_DETAILS'])) ? $user->lang['POST_DETAILS'] : '{ POST_DETAILS }')); } echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>

<table width="100%" cellpadding="3" cellspacing="<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_SPACING'])) ? $this->_tpldata['DEFINE']['.']['CA_SPACING'] : ''; ?>" border="0" class="tablebg">
<tr>
	<td class="row3" colspan="2" align="center"><span class="gensmall"><?php if ($this->_rootref['S_MCP_QUEUE']) {  echo (isset($this->_rootref['RETURN_QUEUE'])) ? $this->_rootref['RETURN_QUEUE'] : ''; ?> | <?php echo (isset($this->_rootref['RETURN_TOPIC_SIMPLE'])) ? $this->_rootref['RETURN_TOPIC_SIMPLE'] : ''; ?> | <?php echo (isset($this->_rootref['RETURN_POST'])) ? $this->_rootref['RETURN_POST'] : ''; } else if ($this->_rootref['S_MCP_REPORT']) {  echo (isset($this->_rootref['RETURN_REPORTS'])) ? $this->_rootref['RETURN_REPORTS'] : ''; ?> | <a href="<?php echo (isset($this->_rootref['U_VIEW_POST'])) ? $this->_rootref['U_VIEW_POST'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_POST'])) ? $this->_rootref['L_VIEW_POST'] : ((isset($user->lang['VIEW_POST'])) ? $user->lang['VIEW_POST'] : '{ VIEW_POST }')); ?></a> | <a href="<?php echo (isset($this->_rootref['U_VIEW_TOPIC'])) ? $this->_rootref['U_VIEW_TOPIC'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_TOPIC'])) ? $this->_rootref['L_VIEW_TOPIC'] : ((isset($user->lang['VIEW_TOPIC'])) ? $user->lang['VIEW_TOPIC'] : '{ VIEW_TOPIC }')); ?></a> | <a href="<?php echo (isset($this->_rootref['U_VIEW_FORUM'])) ? $this->_rootref['U_VIEW_FORUM'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_FORUM'])) ? $this->_rootref['L_VIEW_FORUM'] : ((isset($user->lang['VIEW_FORUM'])) ? $user->lang['VIEW_FORUM'] : '{ VIEW_FORUM }')); ?></a><?php } else { echo (isset($this->_rootref['RETURN_TOPIC'])) ? $this->_rootref['RETURN_TOPIC'] : ''; } ?></span></td>
</tr>
<tr>
...
<?php if ($this->_rootref['S_CAN_VIEWIP']) {  ?>
	...
	<tr>
		<td class="row1"><b class="gen"><?php echo ((isset($this->_rootref['L_THIS_POST_IP'])) ? $this->_rootref['L_THIS_POST_IP'] : ((isset($user->lang['THIS_POST_IP'])) ? $user->lang['THIS_POST_IP'] : '{ THIS_POST_IP }')); ?>: </b></td>
...
<?php if ($this->_rootref['S_MCP_QUEUE']) {  ?>
	...
	<?php if ($this->_rootref['S_TOPIC_REVIEW']) {  $this->_tpl_include('posting_topic_review.html'); } } else { if ($this->_rootref['S_CAN_LOCK_POST'] || $this->_rootref['S_CAN_DELETE_POST'] || $this->_rootref['S_CAN_CHGPOSTER']) {  ?>
		...
		<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_MOD_OPTIONS'])) ? $this->_rootref['L_MOD_OPTIONS'] : ((isset($user->lang['MOD_OPTIONS'])) ? $user->lang['MOD_OPTIONS'] : '{ MOD_OPTIONS }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
	...
	<?php } if ($this->_rootref['S_CAN_VIEWIP']) {  ?>
		...
		<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_START'] : ''; echo ((isset($this->_rootref['L_IP_INFO'])) ? $this->_rootref['L_IP_INFO'] : ((isset($user->lang['IP_INFO'])) ? $user->lang['IP_INFO'] : '{ IP_INFO }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP2_END'] : ''; ?>
		...
		<?php $_userrow_count = (isset($this->_tpldata['userrow'])) ? sizeof($this->_tpldata['userrow']) : 0;if ($_userrow_count) {for ($_userrow_i = 0; $_userrow_i < $_userrow_count; ++$_userrow_i){$_userrow_val = &$this->_tpldata['userrow'][$_userrow_i]; if (!($_userrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
				...
				<td class="row"><span class="gen"><?php if ($_userrow_val['U_PROFILE']) {  ?><a href="<?php echo $_userrow_val['U_PROFILE']; ?>"><?php echo $_userrow_val['USERNAME']; ?></a><?php } else { echo $_userrow_val['USERNAME']; } ?> [ <?php echo $_userrow_val['NUM_POSTS']; ?> <?php echo $_userrow_val['L_POST_S']; ?> ]</span></td>
				<td class="row" align="center"><a href="<?php echo $_userrow_val['U_SEARCHPOSTS']; ?>"><?php echo (isset($this->_rootref['SEARCH_IMG'])) ? $this->_rootref['SEARCH_IMG'] : ''; ?></a></td>
			</tr>
		<?php }} else { ?>

			<tr>
				<td class="row1" colspan="2" align="center"><span class="gen"><?php echo ((isset($this->_rootref['L_NO_MATCHES_FOUND'])) ? $this->_rootref['L_NO_MATCHES_FOUND'] : ((isset($user->lang['NO_MATCHES_FOUND'])) ? $user->lang['NO_MATCHES_FOUND'] : '{ NO_MATCHES_FOUND }')); ?></span></td>
			</tr>
		<?php } ?>
		...
		<?php $_iprow_count = (isset($this->_tpldata['iprow'])) ? sizeof($this->_tpldata['iprow']) : 0;if ($_iprow_count) {for ($_iprow_i = 0; $_iprow_i < $_iprow_count; ++$_iprow_i){$_iprow_val = &$this->_tpldata['iprow'][$_iprow_i]; if (!($_iprow_val['S_ROW_COUNT'] & 1)  ) {  ?>
			...
			<?php } ?>
				...
				<td class="row"><span class="gen"><?php if ($_iprow_val['HOSTNAME']) {  ?><a href="<?php echo $_iprow_val['U_WHOIS']; ?>"><?php echo $_iprow_val['HOSTNAME']; ?></a> (<?php echo $_iprow_val['IP']; ?>)<?php } else { ?><a href="<?php echo $_iprow_val['U_WHOIS']; ?>"><?php echo $_iprow_val['IP']; ?></a><?php } ?> [ <?php echo $_iprow_val['NUM_POSTS']; ?> <?php echo $_iprow_val['L_POST_S']; ?> ]</span></td>
				<td class="row" align="center"><?php if ($_iprow_val['U_LOOKUP_IP']) {  ?><span class="gen">[ <a href="<?php echo $_iprow_val['U_LOOKUP_IP']; ?>"><?php echo ((isset($this->_rootref['L_LOOKUP_IP'])) ? $this->_rootref['L_LOOKUP_IP'] : ((isset($user->lang['LOOKUP_IP'])) ? $user->lang['LOOKUP_IP'] : '{ LOOKUP_IP }')); ?></a> ]</span><?php } ?></td>
			</tr>
		<?php }} else { ?>
