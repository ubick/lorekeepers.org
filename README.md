...
```bash
git clone git@github.com:ubick/lorekeepers.org
```
...
You should now be able to access the site at [http://lorekeepers.org.dev](http://lorekeepers.org.dev)
...
As setup issues are encountered please detail with step by step fix instructions, and where possible update the project itself to provide a more permanent fix.
 ...
 - **Ruby stacktrace mentioning 'hostsupdater' during 'hobo vm up'**
   Please remove any lorekeepers.org.dev entries from your hosts file and retry
